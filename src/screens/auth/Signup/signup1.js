...
//     contactNo: Yup.string().required('Contact number is required').matches(/^\d+$/, 'Contact number must be digits'),
...
//       <Formik
//         initialValues={{ name: '', contactNo: '', email: '', password: '', confirmPassword: '' }}
...
//             />
//             {touched.contactNo && errors.contactNo && <Text style={{ color: 'red' }}>{errors.contactNo}</Text>}
...
//             </TouchableOpacity>
//             <TouchableOpacity
//   // onPress={() => navigation.navigate('Auth', { screen: 'LoginScreen',params:{screen:"LoginScreen"} })}
...
// >
//   <Text style={{ fontSize: 14, color: 'green' }}>Already have an account? Log In</Text>
// </TouchableOpacity>
            ...
            >
              {isLoading ? (
                <>
                  ...
                  <Text style={{ fontSize: 18, color: 'white' }}>Signing Up...</Text>
                </>
              ) : (
                <Text style={{ fontSize: 18, color: 'white' }}>Sign Up</Text>
              )}
